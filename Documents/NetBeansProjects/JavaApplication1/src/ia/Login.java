...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sq1 = "Select * from account";
        Statement stm = con.createStatement();
        ResultSet rs = stm.executeQuery(sq1);
        String pass = new String(jPasswordField1.getPassword());
        while(rs.next()){
        if (jTextField1.getText().equals(rs.getString("user_name"))&& pass.equals(rs.getString("password"))) {
            jOptionPane1.showMessageDialog(null, "Login Sucessfull");
            this.setVisible(false);
            new Dashboard().setVisible(true);
        }
        else{
          jOptionPane1.showMessageDialog(null, "Login Failed. Please Retry");  
        }
        }
        }catch(Exception e){
